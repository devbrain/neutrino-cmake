...
set(NEUTRINO_COMPILER_IS_MSVC OFF)
set(NEUTRINO_COMPILER_IS_GCC OFF)
set(NEUTRINO_COMPILER_IS_CLANG OFF)
set(NEUTRINO_COMPILER_IS_APPLECLANG OFF)
set(NEUTRINO_COMPILER_IS_INTEL OFF)

if(MSVC)
    set(NEUTRINO_COMPILER_IS_MSVC ON)
    set(NEUTRINO_COMPILER_NAME "MSVC")
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    set(NEUTRINO_COMPILER_IS_GCC ON)
    set(NEUTRINO_COMPILER_NAME "GCC")
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "AppleClang")
    set(NEUTRINO_COMPILER_IS_APPLECLANG ON)
    set(NEUTRINO_COMPILER_IS_CLANG ON)
    set(NEUTRINO_COMPILER_NAME "AppleClang")
elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    set(NEUTRINO_COMPILER_IS_CLANG ON)
    set(NEUTRINO_COMPILER_NAME "Clang")
elseif(CMAKE_CXX_COMPILER_ID MATCHES "Intel")
    set(NEUTRINO_COMPILER_IS_INTEL ON)
    set(NEUTRINO_COMPILER_NAME "Intel")
else()
    set(NEUTRINO_COMPILER_NAME "${CMAKE_CXX_COMPILER_ID}")
endif()

# Compiler version
set(NEUTRINO_COMPILER_VERSION "${CMAKE_CXX_COMPILER_VERSION}")
