...
set(NEUTRINO_PLATFORM_WINDOWS OFF CACHE INTERNAL "")
set(NEUTRINO_PLATFORM_LINUX OFF CACHE INTERNAL "")
set(NEUTRINO_PLATFORM_MACOS OFF CACHE INTERNAL "")
set(NEUTRINO_PLATFORM_IOS OFF CACHE INTERNAL "")
set(NEUTRINO_PLATFORM_ANDROID OFF CACHE INTERNAL "")
set(NEUTRINO_PLATFORM_EMSCRIPTEN OFF CACHE INTERNAL "")
set(NEUTRINO_PLATFORM_MOBILE OFF CACHE INTERNAL "")
set(NEUTRINO_PLATFORM_WEB OFF CACHE INTERNAL "")
set(NEUTRINO_PLATFORM_DESKTOP OFF CACHE INTERNAL "")
set(NEUTRINO_PLATFORM_UNIX OFF CACHE INTERNAL "")
set(NEUTRINO_CROSS_COMPILING OFF CACHE INTERNAL "")

if(EMSCRIPTEN)
    set(NEUTRINO_PLATFORM_EMSCRIPTEN ON CACHE INTERNAL "")
    set(NEUTRINO_PLATFORM_WEB ON CACHE INTERNAL "")
    set(NEUTRINO_PLATFORM_NAME "Emscripten" CACHE INTERNAL "")
elseif(WIN32)
    set(NEUTRINO_PLATFORM_WINDOWS ON CACHE INTERNAL "")
    set(NEUTRINO_PLATFORM_NAME "Windows" CACHE INTERNAL "")
elseif(APPLE)
    if(IOS)
        set(NEUTRINO_PLATFORM_IOS ON CACHE INTERNAL "")
        set(NEUTRINO_PLATFORM_MOBILE ON CACHE INTERNAL "")
        set(NEUTRINO_PLATFORM_NAME "iOS" CACHE INTERNAL "")
    else()
        set(NEUTRINO_PLATFORM_MACOS ON CACHE INTERNAL "")
        set(NEUTRINO_PLATFORM_NAME "macOS" CACHE INTERNAL "")
    endif()
elseif(ANDROID)
    set(NEUTRINO_PLATFORM_ANDROID ON CACHE INTERNAL "")
    set(NEUTRINO_PLATFORM_MOBILE ON CACHE INTERNAL "")
    set(NEUTRINO_PLATFORM_NAME "Android" CACHE INTERNAL "")
elseif(UNIX)
    set(NEUTRINO_PLATFORM_LINUX ON CACHE INTERNAL "")
    set(NEUTRINO_PLATFORM_UNIX ON CACHE INTERNAL "")
    set(NEUTRINO_PLATFORM_NAME "Linux" CACHE INTERNAL "")
else()
    set(NEUTRINO_PLATFORM_NAME "Unknown" CACHE INTERNAL "")
endif()
...
# Desktop platforms detection
if(NEUTRINO_PLATFORM_WINDOWS OR NEUTRINO_PLATFORM_LINUX OR NEUTRINO_PLATFORM_MACOS)
    set(NEUTRINO_PLATFORM_DESKTOP ON CACHE INTERNAL "")
endif()

# Cross-compilation detection
if(CMAKE_CROSSCOMPILING OR NEUTRINO_PLATFORM_MOBILE OR NEUTRINO_PLATFORM_WEB)
    set(NEUTRINO_CROSS_COMPILING ON CACHE INTERNAL "")
endif()
